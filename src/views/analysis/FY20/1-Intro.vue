<template>
  <div id="introduction" class="section">
    <p>
      The City of Philadelphia employs about 4,800 people that are not hired
      through the civil service system, known as exempt employees. The
      demographics of this exempt workforce are a direct reflection of the
      City’s hiring practices and can help evaluate the City’s ability to hire
      diverse candidates and maintain an inclusive work environment. The exempt
