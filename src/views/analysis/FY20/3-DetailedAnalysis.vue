<template>
  ...
  <div class="section" id="detailed-analysis">
    ...
    <div class="subsection" id="other-changes">
      <h3>Other Notable Changes</h3>

      <p>
        A few other smaller departments had notable changes in diverse
        representation among their employees. The Office of the Chief
        Administrative Officer dramatically improved its diverse representation
